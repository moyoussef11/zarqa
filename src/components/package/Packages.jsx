...
const Packages = ({
  ...
  return (
    <div className="hover:-translate-y-5 duration-200 m-5 py-6 w-full sm:w-1/5 shadow shadow-black  bg-white text-center flex flex-col items-center rounded  mainColor">
